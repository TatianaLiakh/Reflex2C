...
void GenMain (void)
{
	...
	//fputs("\n#define PROCESS_N1 0", fptr_C);
	//sprintf(string, "\n#define PROCESS_Nn %d", i);
	//fputs(string, fptr_C);
...
void GenVarDescription (void)
{
	...
	/* ====================== I/O Reg ===================== */
	int input_ports_counter = 0;
	int output_ports_counter = 0;
	...
	sprintf(string, "\n#define INPUT_PORTS_COUNTER %d\n", input_ports_counter);
	fputs(string, fptr_XVAR);


	sprintf(string, "#define OUTPUT_PORTS_COUNTER %d\n", output_ports_counter);
	fputs(string, fptr_XVAR);
